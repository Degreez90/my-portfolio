  ...
  return (
    ...
    >
      <div className='relative w-full h-full bg-slate-800/[.40]'>
        <Nav />
        <div className='mx-auto container relative bottom-12 md:bottom-0 grid grid-rows-2 items-center justify-items-center md:justify-items-center md:grid-rows-none md:grid-cols-2 gap-3 px-5'>
